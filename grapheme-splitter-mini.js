...
Usage:
var splitter = require("grapheme-splitter-mini.js");
...
var shouldBreak = function (start, mid, end) {
...
var codePointAt = function (str, idx) {
    if (idx === undefined) {
        idx = 0;
    }
...
var getGraphemeBreakProperty = function (code) {
